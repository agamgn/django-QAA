...
ROOT_DIR = environ.Path(__file__) - 3  # (wenhu/config/settings/base.py - 3 = wenhu/)
APPS_DIR = ROOT_DIR.path('wenhu')  # media, static, staticfiles的文件路径
...
MIGRATION_MODULES = {
    'sites': 'wenhu.contrib.sites.migrations'
}
